...
class block_add extends block_base
{
	...
	public function get_content(){
		...
		// }
			...
			foreach ($roles as $role) {
				$this->content->footer = "message_atrribute  = ".$role->message_attribute;
		}	
	}
		 	
			$sql="SELECT * FROM {blocks_table} WHERE message_attribute='$record->message_attribute'";
